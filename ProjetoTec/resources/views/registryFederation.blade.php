...
<body>   
    <form action="{{route('federations.store')}}" method = 'POST'>
        ...
        <div class="mb-3">
            <label  class="form-label m-3">Estado da Federação</label>
            <input name= "inputFederationState"type="text" class="form-control" id="inputFederacao" placeholder="Difite o nome da Federação">
        </div>
